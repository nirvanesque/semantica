        ...
        **options
        ...
        if len(nodes) > 0:
            try:
                ...
                self.logger.warning(f"NetworkX layout failed: {e}, using basic implementation")
        ...
        **options
        ...
        if len(nodes) > 0:
            try:
                ...
                self.logger.warning(f"NetworkX hierarchical layout failed: {e}, using basic implementation")
