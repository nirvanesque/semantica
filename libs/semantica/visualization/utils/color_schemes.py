...
class ColorPalette:
    ...
    SCHEMES = {
        ...
        ColorScheme.PASTEL: [
            ...
            "#E0BBE4", "#FEC8C1", "#FFCCCB", "#DDA0DD", "#B0E0E6"
        ],
        ColorScheme.DARK: [
            "#2C3E50", "#34495E", "#7F8C8D", "#95A5A6", "#BDC3C7",
            "#ECF0F1", "#3498DB", "#E74C3C", "#F39C12", "#9B59B6"
        ],
        ColorScheme.LIGHT: [
    ...
    @classmethod
    def get_colors(cls, scheme: ColorScheme = ColorScheme.DEFAULT, count: int = 10) -> List[str]:
        """
    ...
    @classmethod
    def get_entity_type_colors(cls, entity_types: List[str], scheme: ColorScheme = ColorScheme.DEFAULT) -> Dict[str, str]:
        """
    ...
    @classmethod
    def get_community_colors(cls, num_communities: int, scheme: ColorScheme = ColorScheme.DEFAULT) -> List[str]:
        """
